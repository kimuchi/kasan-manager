...
**input**: `out/internal/alpha5_12_reviewer_workflow_hardening/sample_reviewed_decisions.csv` (alpha.5.9 master_review_packet)
...
- 入力: `out/internal/alpha5_12_reviewer_workflow_hardening/sample_reviewed_decisions.csv`
- 入力行数: **12**
...
| バケット | 件数 |
|---|---:|
| approved_changes_preview (master修正候補) | 3 |
| blocked_or_incomplete_decisions | 4 |
| pending_decisions | 3 |
