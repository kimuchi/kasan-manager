...
> **訪問看護（医療保険）** | 事業所コード `(未指定)` | 生成日時 `2026-05-10T03:18:34`
> マスタ版 `0.1.0` / 改定タグ `R6_iryou_2024_06` / 適用開始 `2024-06-01`
...
_Generated by CareLinker / judge_kasan.py at 2026-05-10T03:18:34_