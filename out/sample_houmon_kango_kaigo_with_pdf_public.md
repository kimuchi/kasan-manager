...
> **訪問看護（介護保険）** | 事業所コード `DEMO-0007` | 生成日時 `2026-05-11T02:19:16`
...
- generated_at: `2026-05-11T02:19:16`

**サービスコード照合監査（alpha.5.8.1）:**

- audit_version: `alpha.5.8.1`
- audit_date: `2026-05-10`
- 照合元 source_kind: `definitive`
- 照合元タイトル: 介護給付費単位数等サービスコード表（令和6年6月・8月施行版）
- document_version: `2024-05-07版` / effective_date: `2024-06-01 / 2024-08-01`
- 該当範囲: p65-74 訪問看護サービスコード表
- checked: 14 件
- pattern_based_unverified: 7 件
- not_applicable: 1 件
- 注記: alpha.5.5 では「案」資料 (provisional) を根拠としていた。alpha.5.6 で確定版 (definitive) と再照合した。
...
|---|---|---|---|---|---|---|
| 緊急時訪問看護加算(II) | 算定中の推定 | 🟡 partially_clear | ✅ 公式照合済 | 緊急時訪問看護加算の届出が完了している / 24時間連絡体制が整備されている | tenant_status.kinkyu_kango_setsumei_doui.status | - |
| 認知症専門ケア加算（訪問看護では算定対象外） | 対象外 | 🚫 当サービス対象外 | 🚫 対象外 | - | - | - |
