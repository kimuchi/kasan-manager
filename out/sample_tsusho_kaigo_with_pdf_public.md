...
> **通所介護** | 事業所コード `DEMO-0004` | 生成日時 `2026-05-11T02:19:03`
...
- generated_at: `2026-05-11T02:19:03`
...
|---|---|---|---|---|---|---|
| 中重度者ケア体制加算 | 算定中の推定 | 🟡 partially_clear | ℹ️ 帳票パターン | PDF evidence上、要介護3以上が30%以上 / 利用者集計: 要介護3以上が30%以上 / tenant_status: 看護・介護職員2名以上加配 / 職員データ集計: 看護・介護職員常勤換算2.0以上 | tenant_status.kango_jikantai_haichi.status | ℹ️ pattern_based_unverified |
